...
const PlayModal = () => {
    return <div className='w-full flex flex-col text-fontgrey text-sm gap-4'>
        ...
        <p className="text-fontgrey text-sm">By earning Points you move up levels. Each level reached earns your shards into Gaimin. And the number of point decided how much $GMRX you will be able to claim.</p>
        ...
        <p className="text-fontgrey text-sm">At the end of each Season, your points and levels will drop back 0, but your shards will be saved. Each Season present a new challenge, but at the end of the Gaimin portal experience, your total no of shards will be fused into Gaimin and converted into $GMRX.</p>

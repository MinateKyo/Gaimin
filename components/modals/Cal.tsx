...
const Cal = (props: { data: any }) => {
    ...
    return <div className='w-full flex flex-col text-fontgrey text-sm gap-4'>
        <p className="text-fontgrey text-sm">Calculate how many points you het from your tweets in the season The more points you get, the higher the level your progress, the more $GMRX shards you receive. Shards can be fused into Gaimin. Gaimin give you $GMRX.</p>
